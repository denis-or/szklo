...
df_tab_1_5 <-
  tibble::tibble(
    ...
    age_group_35 = c(NA, 12, 19, 30, 35),
    age_group_45 = c(10, 18, 26, 30, NA),
    age_group_55 = c(15, 22, 26, NA, NA),
    age_group_65 = c(20, 22, NA, NA, NA),
    age_group_75 = c(20, NA, NA, NA, NA)
  )
```


```{r}
df_tab_1_5_t <- df_tab_1_5 |>
  tidyr::pivot_longer(
...
my_g <- grid::grobTree(
  ...
  gridtext::richtext_grob(
    "**FIGURE 1-5** Hypothetical example of period effect. An event happened in 1995 that affected all birth cohorts<br>(1930–1970) in a similar way and slowed down the rate of increase with age. The solid line represents the observed<br>cross-sectional age pattern in 2005.",
    x = .03,
    hjust = 0,
...
ggplot2::ggsave("figure_1_5.png", g2, width = 9, height = 5)
